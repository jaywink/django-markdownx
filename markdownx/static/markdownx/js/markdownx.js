(function e(t, n, r) {
    ...
    1: [ function(require, module, exports) {
        ...
        var UPLOAD_URL_ATTRIBUTE = "data-markdownx-upload-urls-path", PROCESSING_URL_ATTRIBUTE = "data-markdownx-urls-path", RESIZABILITY_ATTRIBUTE = "data-markdownx-editor-resizable", LATENCY_ATTRIBUTE = "data-markdownx-latency", DISABLE_KEYS_ATTRIBUTE = "data-markdownx-disable-keys", LATENCY_MINIMUM = 500, XHR_RESPONSE_ERROR = "Invalid response", UPLOAD_START_OPACITY = "0.3", NORMAL_OPACITY = "1";
        var EventHandlers = {
        ...
        var MarkdownX = function(parent, editor, preview) {
            ...
            var insertImage = function(textToInsert) {
                properties.editor.value = properties.editor.value.substring(0, properties.editor.selectionStart) + "\n\n" + textToInsert + ("\n\n" + properties.editor.value.substring(properties.editor.selectionEnd));
    ...
    2: [ function(require, module, exports) {
        ...
        var Request = function() {
            ...
            Request.prototype.progress = function(event) {
                if (event.lengthComputable) console.log(event.loaded / event.total * 100 + "% uploaded");
            };
